...
function toCellChar(value: number): string {
  switch(value & 0x7F) {
    case Character.none: return ' ';
    case Character.dash: return '-';
    case Character.a: return 'a';
    case Character.b: return 'b';
    case Character.c: return 'c';
    case Character.d: return 'd';
    case Character.e: return 'e';
    case Character.f: return 'f';
    case Character.g: return 'g';
    case Character.h: return 'h';
    case Character.i: return 'i';
    case Character.j: return 'j';
    case Character.k: return 'k';
    case Character.l: return 'l';
    case Character.m: return 'm';
    case Character.n: return 'n';
    case Character.o: return 'o';
    case Character.p: return 'p';
    case Character.q: return 'q';
    case Character.r: return 'r';
    case Character.s: return 's';
    case Character.t: return 't';
    case Character.u: return 'u';
    case Character.v: return 'v';
    case Character.w: return 'w';
    case Character.x: return 'x';
    case Character.y: return 'y';
    case Character.z: return 'z';
  }
  return '';
}
  ...
  refresh(app: Application) {
   ...
   // });
    for (let i = 0; i < this.data.length; i++) {
      ...
      const y = (this.y * GRID_SIZE + Math.floor(i / GRID_SIZE)) + (this.y * GRID_SIZE);
      const v = toCellEnum(value);
      switch (v) {
        case Character.none:
          const blockedCell = new Graphics()
            .rect((x * CELL_PX_SIZE), (y * CELL_PX_SIZE), CELL_PX_SIZE - CELL_PX_PADDING, CELL_PX_SIZE - CELL_PX_PADDING)
            .fill(0x000000);
